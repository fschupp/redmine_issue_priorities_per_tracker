...
Since PrototypeJS was removed in Rails 3.2, this plugin now depends on the https://github.com/fschupp/redmine_prototype_js Plugin which provides this functionality.
